...
@Component
public class JwtRequestFilterRescueHelper extends OncePerRequestFilter {

    @Autowired
    private JwtRescueHelperDetailsService jwtRescueHelperDetailsService;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            UserDetails userDetails = this.jwtRescueHelperDetailsService.loadUserByUsername(username);
